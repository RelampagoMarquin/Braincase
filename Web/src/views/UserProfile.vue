        ...
        <v-col cols="12" md="12" lg="5">
          <div class="rounded-xl elevation-2 my-4 form-bg">
            ...
            <v-form action="#" method="post" class="px-10">
              <v-text-field type="text" variant="solo" placeholder="Nome" v-model="name" />
              <v-text-field type="email" variant="solo" placeholder="E-mail" v-model="email" />
              <v-text-field
                type="password"
                variant="solo"
                placeholder="Senha"
              ...
              <v-text-field
                ...
                v-model="oldPassword"
              />
              <v-text-field type="password" variant="solo" placeholder="Senha" v-model="password" />
              <v-text-field
                type="password"
                variant="solo"
                placeholder="Confirme a senha"
